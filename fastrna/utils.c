...
#define __PYX_HAVE__fastrna__utils
#define __PYX_HAVE_API__fastrna__utils
/* Early includes */
#include <math.h>
#include <string.h>
#include <stdio.h>
...
#define __Pyx_MODULE_NAME "fastrna.utils"
extern int __pyx_module_is_main_fastrna__utils;
int __pyx_module_is_main_fastrna__utils = 0;

/* Implementation of 'fastrna.utils' */
...
static void __pyx_f_7fastrna_5utils_spmatrix_to_dense_csc(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_indices, __Pyx_memviewslice __pyx_v_ptrB, __Pyx_memviewslice __pyx_v_ptrC, CYTHON_UNUSED int __pyx_v_nrow, int __pyx_v_ncol, __Pyx_memviewslice __pyx_v_result) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_i_end;
  Py_ssize_t __pyx_v_i_begin;
 ...
 */
    __pyx_t_4 = __pyx_v_j;
    __pyx_v_i_begin = (*((int const  *) ( /* dim=0 */ (__pyx_v_ptrB.data + __pyx_t_4 * __pyx_v_ptrB.strides[0]) )));

    /* "fastrna/utils.pyx":25
 *     for j in range(ncol):
 *         i_begin = ptrB[j]
 *         i_end = ptrC[j]             # <<<<<<<<<<<<<<
 *         for i in range(i_begin, i_end):
 ...
 */
    __pyx_t_4 = __pyx_v_j;
    __pyx_v_i_end = (*((int const  *) ( /* dim=0 */ (__pyx_v_ptrC.data + __pyx_t_4 * __pyx_v_ptrC.strides[0]) )));

    /* "fastrna/utils.pyx":26
 *         i_begin = ptrB[j]
 *         i_end = ptrC[j]
 *         for i in range(i_begin, i_end):             # <<<<<<<<<<<<<<
 *             result[indices[i], j] = data[i]
 * 
 */
    __pyx_t_5 = __pyx_v_i_end;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = __pyx_v_i_begin; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v_i = __pyx_t_7;

      /* "fastrna/utils.pyx":27
 *         i_end = ptrC[j]
 *         for i in range(i_begin, i_end):
 *             result[indices[i], j] = data[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_4 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_i;
      __pyx_t_9 = (*((int const  *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_8 * __pyx_v_indices.strides[0]) )));
      __pyx_t_10 = __pyx_v_j;
      *((float *) ( /* dim=1 */ (( /* dim=0 */ ((char *) (((float *) __pyx_v_result.data) + __pyx_t_9)) ) + __pyx_t_10 * __pyx_v_result.strides[1]) )) = (*((float const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_4 * __pyx_v_data.strides[0]) )));
    }
  }
...
static void __pyx_f_7fastrna_5utils_spmatrix_to_dense_csr(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_indices, __Pyx_memviewslice __pyx_v_ptrB, __Pyx_memviewslice __pyx_v_ptrC, int __pyx_v_nrow, CYTHON_UNUSED int __pyx_v_ncol, __Pyx_memviewslice __pyx_v_result) {
  Py_ssize_t __pyx_v_i;
  Py_ssize_t __pyx_v_i_end;
  Py_ssize_t __pyx_v_i_begin;
  Py_ssize_t __pyx_v_j;
 ...
 */
      ...
      __pyx_t_8 = __pyx_v_i;
      __pyx_t_9 = __pyx_v_j;
      __pyx_t_10 = (*((int const  *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_8 * __pyx_v_indices.strides[0]) )));
      *((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_9 * __pyx_v_result.strides[0]) )) + __pyx_t_10)) )) = (*((float const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_4 * __pyx_v_data.strides[0]) )));
    }
  }
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_csc_div_vec_row(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_indices, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_indptr, __Pyx_memviewslice __pyx_v_vec) {
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  CYTHON_UNUSED Py_ssize_t __pyx_v_nnz;
  Py_ssize_t __pyx_v_i;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("csc_div_vec_row", 0);

  /* "fastrna/utils.pyx":61
 *         ):
 * 
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_data.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 61, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":62
 * 
 *     cdef float[:] result = np.empty(data.shape[0], dtype=np.float32)
 *     cdef Py_ssize_t nnz = data.shape[0]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t i
 *     with nogil:
 */
  __pyx_v_nnz = (__pyx_v_data.shape[0]);

  /* "fastrna/utils.pyx":64
 *     cdef Py_ssize_t nnz = data.shape[0]
 *     cdef Py_ssize_t i
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in prange(nnz):
 ...
 */
                            ...
                            __pyx_t_12 = (*((int const  *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_11 * __pyx_v_indices.strides[0]) )));
                            __pyx_t_13 = __pyx_v_i;
                            *((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_13 * __pyx_v_result.strides[0]) )) = ((*((float const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_10 * __pyx_v_data.strides[0]) ))) / (*((float const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_12 * __pyx_v_vec.strides[0]) ))));
                        }
                    }
                }
            }
 ...
 */
  ...
  __Pyx_AddTraceback("fastrna.utils.csc_div_vec_row", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_csc_div_vec_col(__Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_indices, __Pyx_memviewslice __pyx_v_indptr, __Pyx_memviewslice __pyx_v_vec) {
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("csc_div_vec_col", 0);

  /* "fastrna/utils.pyx":81
 *         ):
 * 
 *     cdef float[:] result = np.empty(data.shape[0], dtype=np.float32)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_data.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":82
 * 
 *     cdef float[:] result = np.empty(data.shape[0], dtype=np.float32)
 *     cdef Py_ssize_t ncol = indptr.shape[0] - 1             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t i, i_begin, i_end, j
 *     with nogil:
 */
  __pyx_v_ncol = ((__pyx_v_indptr.shape[0]) - 1);

  /* "fastrna/utils.pyx":84
 *     cdef Py_ssize_t ncol = indptr.shape[0] - 1
 *     cdef Py_ssize_t i, i_begin, i_end, j
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if ((1 == 0)) abort();
        {
            ...
            if (__pyx_t_9 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for lastprivate(__pyx_v_i) lastprivate(__pyx_v_i_begin) lastprivate(__pyx_v_i_end) firstprivate(__pyx_v_j) lastprivate(__pyx_v_j)
                    #endif /* _OPENMP */
                    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_9; __pyx_t_8++){
                        {
                            ...
                            __pyx_v_i_begin = ((Py_ssize_t)0xbad0bad0);
                            __pyx_v_i_end = ((Py_ssize_t)0xbad0bad0);

                            /* "fastrna/utils.pyx":86
 *     with nogil:
 *         for j in prange(ncol):
 *             i_begin = indptr[j]             # <<<<<<<<<<<<<<
 *             i_end = indptr[j+1]
 ...
 */
                            __pyx_t_10 = __pyx_v_j;
                            __pyx_v_i_begin = (*((int const  *) ( /* dim=0 */ (__pyx_v_indptr.data + __pyx_t_10 * __pyx_v_indptr.strides[0]) )));

                            /* "fastrna/utils.pyx":87
 *         for j in prange(ncol):
 *             i_begin = indptr[j]
 *             i_end = indptr[j+1]             # <<<<<<<<<<<<<<
 *             for i in range(i_begin, i_end):
 ...
 */
                            ...
                            __pyx_v_i_end = (*((int const  *) ( /* dim=0 */ (__pyx_v_indptr.data + __pyx_t_10 * __pyx_v_indptr.strides[0]) )));

                            /* "fastrna/utils.pyx":88
 *             i_begin = indptr[j]
 *             i_end = indptr[j+1]
 *             for i in range(i_begin, i_end):             # <<<<<<<<<<<<<<
 *                 result[i] = data[i] / vec[j]
 * 
 */
                            __pyx_t_11 = __pyx_v_i_end;
                            __pyx_t_12 = __pyx_t_11;
                            for (__pyx_t_13 = __pyx_v_i_begin; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
                              __pyx_v_i = __pyx_t_13;

                              /* "fastrna/utils.pyx":89
 *             i_end = indptr[j+1]
 *             for i in range(i_begin, i_end):
 *                 result[i] = data[i] / vec[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              ...
                              *((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_15 * __pyx_v_result.strides[0]) )) = ((*((float const  *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_10 * __pyx_v_data.strides[0]) ))) / (*((float const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_14 * __pyx_v_vec.strides[0]) ))));
                            }
                        }
                    }
                }
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fastrna.utils.csc_div_vec_col", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_mul(__Pyx_memviewslice __pyx_v_vec1, __Pyx_memviewslice __pyx_v_vec2) {
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_vec1.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 103, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 103, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 103, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":104
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec1.shape[0], dtype=np.float32)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in prange(vec1.shape[0]):
 ...
 * 
 */
        if (unlikely(!__pyx_v_vec1.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec1"); __PYX_ERR(0, 105, __pyx_L4_error) }
        __pyx_t_7 = (__pyx_v_vec1.shape[0]);
        if ((1 == 0)) abort();
        {
            #if ((defined(__APPLE__) || defined(__OSX__)) && (defined(__GNUC__) && (__GNUC__ > 2 || (__GNUC__ == 2 && (__GNUC_MINOR__ > 95)))))
                #undef likely
 ...
 */
                            ...
                            *((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_12 * __pyx_v_result.strides[0]) )) = ((*((float const  *) ( /* dim=0 */ (__pyx_v_vec1.data + __pyx_t_10 * __pyx_v_vec1.strides[0]) ))) * (*((float const  *) ( /* dim=0 */ (__pyx_v_vec2.data + __pyx_t_11 * __pyx_v_vec2.strides[0]) ))));
                        }
                    }
                }
            }
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fastrna.utils.mul", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_div(__Pyx_memviewslice __pyx_v_vec1, __Pyx_memviewslice __pyx_v_vec2) {
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_vec1.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 120, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":121
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec1.shape[0], dtype=np.float32)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in prange(vec1.shape[0]):
 ...
 * 
 */
        if (unlikely(!__pyx_v_vec1.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec1"); __PYX_ERR(0, 122, __pyx_L4_error) }
        __pyx_t_7 = (__pyx_v_vec1.shape[0]);
        if ((1 == 0)) abort();
        {
            #if ((defined(__APPLE__) || defined(__OSX__)) && (defined(__GNUC__) && (__GNUC__ > 2 || (__GNUC__ == 2 && (__GNUC_MINOR__ > 95)))))
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fastrna.utils.div", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_norm1(__Pyx_memviewslice __pyx_v_vec) {
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_num;
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("norm1", 0);

  /* "fastrna/utils.pyx":136
 * 
 *     cdef Py_ssize_t i
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_vec.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 136, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 136, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 136, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":137
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec.shape[0], dtype=np.float32)
 *     cdef float num = 0             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 *         for i in prange(vec.shape[0]):
 */
        if (unlikely(!__pyx_v_vec.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec"); __PYX_ERR(0, 139, __pyx_L4_error) }
        ...
        if ((1 == 0)) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_num) private(__pyx_t_10)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i)
 ...
 */
                            __pyx_t_10 = __pyx_v_i;
                            __pyx_v_num = (__pyx_v_num + (*((float const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_10 * __pyx_v_vec.strides[0]) ))));
                        }
                    }
                }
            }
 ...
 * 
 */
        if (unlikely(!__pyx_v_vec.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec"); __PYX_ERR(0, 141, __pyx_L4_error) }
 ...
 */
                            __pyx_t_10 = __pyx_v_i;
                            __pyx_t_11 = __pyx_v_i;
                            *((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_11 * __pyx_v_result.strides[0]) )) = ((*((float const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_10 * __pyx_v_vec.strides[0]) ))) / __pyx_v_num);
                        }
                    }
                }
            }
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fastrna.utils.norm1", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_inv(__Pyx_memviewslice __pyx_v_vec) {
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_vec.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 155, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 155, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 155, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":156
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec.shape[0], dtype=np.float32)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in prange(vec.shape[0]):
 ...
 * 
 */
        if (unlikely(!__pyx_v_vec.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec"); __PYX_ERR(0, 157, __pyx_L4_error) }
        __pyx_t_7 = (__pyx_v_vec.shape[0]);
        if ((1 == 0)) abort();
        {
            #if ((defined(__APPLE__) || defined(__OSX__)) && (defined(__GNUC__) && (__GNUC__ > 2 || (__GNUC__ == 2 && (__GNUC_MINOR__ > 95)))))
 ...
 */
                            __pyx_t_10 = __pyx_v_i;
                            __pyx_t_11 = __pyx_v_i;
                            *((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_11 * __pyx_v_result.strides[0]) )) = (1.0 / (*((float const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_10 * __pyx_v_vec.strides[0]) ))));
                        }
                    }
                }
            }
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fastrna.utils.inv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_pcomp(__Pyx_memviewslice __pyx_v_vec) {
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("pcomp", 0);

  /* "fastrna/utils.pyx":171
 * 
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec.shape[0], dtype=np.float32)             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_vec.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 171, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 171, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 171, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 171, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 171, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":172
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec.shape[0], dtype=np.float32)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in prange(vec.shape[0]):
 ...
 * 
 */
        if (unlikely(!__pyx_v_vec.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec"); __PYX_ERR(0, 173, __pyx_L4_error) }
        __pyx_t_7 = (__pyx_v_vec.shape[0]);
        if ((1 == 0)) abort();
        {
            #if ((defined(__APPLE__) || defined(__OSX__)) && (defined(__GNUC__) && (__GNUC__ > 2 || (__GNUC__ == 2 && (__GNUC_MINOR__ > 95)))))
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fastrna.utils.pcomp", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_sqrt_c(__Pyx_memviewslice __pyx_v_vec) {
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("sqrt_c", 0);

  /* "fastrna/utils.pyx":187
 * 
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec.shape[0], dtype=np.float32)             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_vec.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":188
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec.shape[0], dtype=np.float32)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in prange(vec.shape[0]):
 ...
 * 
 */
        if (unlikely(!__pyx_v_vec.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec"); __PYX_ERR(0, 189, __pyx_L4_error) }
        __pyx_t_7 = (__pyx_v_vec.shape[0]);
        if ((1 == 0)) abort();
        {
            #if ((defined(__APPLE__) || defined(__OSX__)) && (defined(__GNUC__) && (__GNUC__ > 2 || (__GNUC__ == 2 && (__GNUC_MINOR__ > 95)))))
 ...
 */
                            __pyx_t_10 = __pyx_v_i;
                            __pyx_t_11 = __pyx_v_i;
                            *((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_11 * __pyx_v_result.strides[0]) )) = sqrt((*((float const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_10 * __pyx_v_vec.strides[0]) ))));
                        }
                    }
                }
            }
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fastrna.utils.sqrt_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static __Pyx_memviewslice __pyx_f_7fastrna_5utils_mul_s(__Pyx_memviewslice __pyx_v_vec, float const __pyx_v_s) {
  Py_ssize_t __pyx_v_i;
  __Pyx_memviewslice __pyx_v_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("mul_s", 0);

  /* "fastrna/utils.pyx":203
 * 
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec.shape[0], dtype=np.float32)             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t((__pyx_v_vec.shape[0])); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 203, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 203, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 203, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_result = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "fastrna/utils.pyx":204
 *     cdef Py_ssize_t i
 *     cdef float[:] result = np.empty(vec.shape[0], dtype=np.float32)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in prange(vec.shape[0]):
 ...
 * 
 */
        if (unlikely(!__pyx_v_vec.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec"); __PYX_ERR(0, 205, __pyx_L4_error) }
        __pyx_t_7 = (__pyx_v_vec.shape[0]);
        if ((1 == 0)) abort();
        {
            #if ((defined(__APPLE__) || defined(__OSX__)) && (defined(__GNUC__) && (__GNUC__ > 2 || (__GNUC__ == 2 && (__GNUC_MINOR__ > 95)))))
 ...
 */
                            __pyx_t_10 = __pyx_v_i;
                            __pyx_t_11 = __pyx_v_i;
                            *((float *) ( /* dim=0 */ (__pyx_v_result.data + __pyx_t_11 * __pyx_v_result.strides[0]) )) = ((*((float const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_10 * __pyx_v_vec.strides[0]) ))) * __pyx_v_s);
                        }
                    }
                }
            }
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("fastrna.utils.mul_s", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
...
static float __pyx_f_7fastrna_5utils_vsum(__Pyx_memviewslice __pyx_v_vec) {
  Py_ssize_t __pyx_v_i;
 ...
 * 
 */
        if (unlikely(!__pyx_v_vec.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("vec"); __PYX_ERR(0, 220, __pyx_L4_error) }
        ...
        if ((1 == 0)) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel reduction(+:__pyx_v_result) private(__pyx_t_4)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i)
 ...
 */
                            __pyx_t_4 = __pyx_v_i;
                            __pyx_v_result = (__pyx_v_result + (*((float const  *) ( /* dim=0 */ (__pyx_v_vec.data + __pyx_t_4 * __pyx_v_vec.strides[0]) ))));
                        }
                    }
                }
            }
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("fastrna.utils.vsum", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastrna.utils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastrna.utils._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("spmatrix_to_dense_csc", (void (*)(void))__pyx_f_7fastrna_5utils_spmatrix_to_dense_csc, "void (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("spmatrix_to_dense_csr", (void (*)(void))__pyx_f_7fastrna_5utils_spmatrix_to_dense_csr, "void (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("csc_div_vec_row", (void (*)(void))__pyx_f_7fastrna_5utils_csc_div_vec_row, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("csc_div_vec_col", (void (*)(void))__pyx_f_7fastrna_5utils_csc_div_vec_col, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("mul", (void (*)(void))__pyx_f_7fastrna_5utils_mul, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("div", (void (*)(void))__pyx_f_7fastrna_5utils_div, "__Pyx_memviewslice (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("norm1", (void (*)(void))__pyx_f_7fastrna_5utils_norm1, "__Pyx_memviewslice (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("inv", (void (*)(void))__pyx_f_7fastrna_5utils_inv, "__Pyx_memviewslice (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("pcomp", (void (*)(void))__pyx_f_7fastrna_5utils_pcomp, "__Pyx_memviewslice (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("sqrt_c", (void (*)(void))__pyx_f_7fastrna_5utils_sqrt_c, "__Pyx_memviewslice (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("mul_s", (void (*)(void))__pyx_f_7fastrna_5utils_mul_s, "__Pyx_memviewslice (__Pyx_memviewslice, float const )") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("vsum", (void (*)(void))__pyx_f_7fastrna_5utils_vsum, "float (__Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_fastrna__utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fastrna.utils")) {
      if (unlikely(PyDict_SetItemString(modules, "fastrna.utils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fastrna.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fastrna.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
